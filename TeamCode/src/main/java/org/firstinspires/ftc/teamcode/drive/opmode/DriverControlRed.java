...
@TeleOp
public class DriverControlRed extends LinearOpMode {
...
//Adding above into code.  When code is active, this is active.  Defines the wheels and wheel direction
        ...
        */
        ...
        //this one shoudl work now and should be the one that we use from now on
        waitForStart();
        while (opModeIsActive()) {
            double drive = gamepad1.right_stick_y;
            double strafe = gamepad1.left_stick_x;
